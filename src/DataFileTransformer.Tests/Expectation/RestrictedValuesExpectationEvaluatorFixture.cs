...
namespace DataFileTransformer.Tests.Expectation
{
    ...
    public class RestrictedValuesExpectationEvaluatorFixture
    {
        ...
        public void IsFullFilledCorrectlyDealsWithNonNullsValuesInCaseSensitiveComparisonContext(string[] restrictedValues, string input, bool expectedResult)
        {
        ...
        [Row(new[] { "Hole", "in", " one" }, "one", false)]
        [Row(new[] { "Hole", "in", "one" }, "one ", false)]
        public void IsFullFilledCorrectlyDealsWithNonNullsValuesInCaseInsensitiveComparisonContext(string[] restrictedValues, string input, bool expectedResult)
        {
            RestrictedValuesExpectationEvaluator restrictedValuesExpectationEvaluator = CreateSUT(restrictedValues, false);
            Assert.AreEqual(expectedResult, restrictedValuesExpectationEvaluator.IsFulfilled(input));
        }
        ...
        {
            RestrictedValuesExpectationEvaluator restrictedValuesExpectationEvaluator = CreateSUT(new[] { "Hole", "in", "one" }, true);
        ...
        private static RestrictedValuesExpectationEvaluator CreateSUT(IEnumerable<string> restrictedValues, bool isCaseSentive)
        {
